...
/// List response for the caller's organization: the branches plus the plan's
...
/// All branches of the signed-in user's organization (server-scoped — an
/// Organization Admin never has to pass their own organizationId).
...
class BranchesNotifier extends AsyncNotifier<void> {
  ...
  /// Creates a branch for the caller's own organization and returns it.
  ...
  /// Organization Admin back to /onboarding off a stale `false`).

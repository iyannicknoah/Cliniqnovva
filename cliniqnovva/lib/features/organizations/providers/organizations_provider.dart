...
final organizationDetailProvider = FutureProvider.autoDispose
    .family<Organization, String>((ref, id) async {
      final response = await ApiService.instance.get<Map<String, dynamic>>(
...
final paymentHistoryProvider = FutureProvider.autoDispose
    .family<List<SubscriptionPayment>, String>((ref, id) async {
      final response = await ApiService.instance.get<Map<String, dynamic>>(
        '/api/v1/organizations/$id/payment-history',
      );
...
class OrganizationsNotifier extends AsyncNotifier<void> {
  ...
  Future<void> setBillingStatus(String id, String billingStatus) async {
    await ApiService.instance.put<Map<String, dynamic>>(
      '/api/v1/organizations/$id/billing-status',
...
final organizationsNotifierProvider =
    AsyncNotifierProvider<OrganizationsNotifier, void>(

...
/// Organization Admin: every branch of their clinic (employee count each),
    ...
    return Scaffold(
      ...
      body: claims.when(
        ...
        data: (data) {
          ...
          return const _OrganizationBranchesView();
        },
      ),
    );
  }
...
/// Organization Admin: all branches, add/edit/deactivate, dashboard filter.
class _OrganizationBranchesView extends ConsumerWidget {
  const _OrganizationBranchesView();

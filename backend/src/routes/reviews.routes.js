...
router.get('/', requireRole(ROLES.PATIENT, ROLES.RECEPTIONIST, ROLES.BRANCH_ADMIN, ROLES.ORGANIZATION_ADMIN, ROLES.DOCTOR), controller.list);
router.get('/:id', requireRole(ROLES.PATIENT, ROLES.RECEPTIONIST, ROLES.BRANCH_ADMIN, ROLES.ORGANIZATION_ADMIN, ROLES.DOCTOR), controller.getById);
